...
#     "LoginResult": "LoginResult"
    ...
    "ActionResult<String>": "ActionResult<String>",
    "ActionResult<TwoFactorSetupInfo>": "ActionResult<Value>",
    "RunningTask": "RunningTask",
    "IEnumerable<RunningTask>": "Vec<RunningTask>",
    ...
    "Dictionary<String, Dictionary<String, MethodInfoSummary>>": "HashMap<String, HashMap<String, Value>>",
    "Dictionary<String, Int32>": "Map<String, Value>",
    "Dictionary<String, SettingSpec>": "Map<String, Value>",
    "Dictionary<String, String>": "Map<String, Value>",
    "IDictionary<Guid, String>": "Map<UUID, Value>",
    "IDictionary<String, String>": "HashMap<String, String>",
    "IEnumerable<ApplicationSpec>": "Vec<Value>",
    "IEnumerable<AuthRoleSummary>": "Vec<Value>",
    "IEnumerable<BackupManifest>": "Vec<Value>",
    "IEnumerable<DeploymentTemplate>": "Vec<Value>",
    "IEnumerable<EndpointInfo>": "Vec<EndpointInfo>",
    "IEnumerable<IADSInstance>": "Vec<IADSInstance>",
    "IEnumerable<IAuditLogEntry>": "Vec<Value>",
    "IEnumerable<InstanceDatastore>": "Vec<Value>",
    "IEnumerable<JObject>": "Vec<Value>",
    "IEnumerable<ListeningPortSummary>": "Vec<Value>",
    "IEnumerable<PortUsage>": "Vec<Value>",
    "IEnumerable<ProvisionSettingInfo>": "Vec<Value>",
    "IEnumerable<String>": "Vec<String>",
    "IEnumerable<UserInfo>": "Vec<UserInfo>",
    "IEnumerable<UserInfoSummary>": "Vec<Value>",
    "IEnumerable<WebauthnCredentialSummary>": "Vec<Value>",
    "IEnumerable<WebSessionSummary>": "Vec<Value>",
    "IList<IPermissionsTreeNode>": "Vec<Value>",
    "List<JObject>": "Vec<Value>",
    "List<String>": "Vec<String>",
    "Nullable<Boolean>": "Option<bool>", # Optional?
